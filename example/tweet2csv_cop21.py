...
#open file
saveFile = open('AccordDeParis.csv', 'a')
headers = 'Time; User; Text; Sentiment; Question; Place; Latitude; Longitude;'
saveFile.write(headers + '\n')

##print tweets
for tweet in tweepy.Cursor(api.search, q ='#AccordDeParis', since_id = '675745969141600256', count = '100').items():
    '''
    Parameters (*required):
    ...
    ##
    ##        #save tweets
    ##        saveThis = str(moment) + '; ' + str(string.encode('utf-8', 'ignore')) + '; ' + user + '; ' + sentiment + '; ' + question + '; ' + place + '; ' + str(latitude) + '; ' + str(longitude) + '; '
    ##        saveFile.write(saveThis + '\n')
    except:
        pass
#close file
